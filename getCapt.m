...
%spear
captPt13=[ 3*captSize; -2*captSize; 1]; % tip of right hand
captPt14=[ -captSize; -2*captSize; 1]; % base of right hand
captPt15=[ -captSize; 2*captSize; 1]; % base of left hand
captPt16=[3*captSize; 2*captSize; 1]; % tip of left land
%elbow
captPt17=[0.5*captSize; -1.5*captSize; 1];
